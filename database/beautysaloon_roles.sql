...
INSERT INTO `roles` VALUES (0,'Пользователь','Пользователь услуг может записаться на услугу.'),(1,'Мастер','Мастер ведет учет оказываемых им услуг'),(2,'Администратор','Администратор ведет учета персонала, услуг. Администрирует салон красоты.');
